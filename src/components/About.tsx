  ...
  return (
    <section id="about" className="section-padding bg-light-gray" ref={ref}>
      <div className="section-container">
        ...
        >
          <h3 className="heading-md text-primary mb-10">Our Core Values</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {values.map((value, index) => (
              <motion.div
                ...
                className="group p-6 bg-background rounded-xl border border-border shadow-sm hover:shadow-lg hover:border-accent/30 transition-all duration-300 cursor-pointer"
              >
